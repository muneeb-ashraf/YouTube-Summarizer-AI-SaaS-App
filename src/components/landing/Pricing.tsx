      ...
      <div className="container mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <Card className={cn("shadow-lg", { "border-indigo-500": false })}>
            <CardHeader>
              <CardTitle className="text-2xl font-bold">Starter - $49</CardTitle>
          ...
          <Card className={cn("shadow-lg", { "border-indigo-500": true })}>
            <CardHeader>
              <CardTitle className="text-2xl font-bold">Pro - $79</CardTitle>
              <p className="text-sm text-muted-foreground">
          ...
          <Card className={cn("shadow-lg", { "border-indigo-500": false })}>
            <CardHeader>
              <CardTitle className="text-2xl font-bold">Pro Plus - $99</CardTitle>
